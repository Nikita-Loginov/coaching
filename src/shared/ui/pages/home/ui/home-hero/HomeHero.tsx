        ...
        <div className={scss["home-hero__inner"]}>
          <div className={scss["home-hero__block"]}>
            ...
            <h1 className="h1 text-center font-text-second">
              Люди работают вместе. <br /> Но всегда ли они работают как команда?
            </h1>
          </div>
          ...
          <div className={scss["home-hero__footer"]}>
            <div className={scss["home-hero__btns"]}>
              <ContactMessageBtn theme="primary" size="medium">
                <p className="p2">Обсудить задачу</p>
              </ContactMessageBtn>

              <Button theme="secondary" size="medium" as="link" to="#programs">
            ...
            <ListsDots
              items={[
                <p className="p4">{PERSON_CONFIG.experience} лет работы с бизнес-командами</p>,
                <p className="p4">
                  {PERSON_CONFIG.post}
                </p>,
                <p className="p4">Командный коучинг</p>,
              ]}
